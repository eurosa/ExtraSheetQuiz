...
public class AddInitialWallet extends AppCompatActivity {
    TextView tv_title;
    ImageView iv_back;
    EditText et_amt;
    Button btn_add_amt;
    ...
    Activity ctx=AddInitialWallet.this;
    ...
    private void getAmount() {
        loadingBar.show();
        config_ref.child(chld).child("amount").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void updateAmount() {
        ...
        config_ref.child(chld).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
           ...
           {
               toastMsg.toastIconSuccess("Initial Wallet amount update successfully.");
               finish();
           }
           else
           {
